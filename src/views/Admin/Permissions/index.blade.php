    ...
    <div class="container">
        ...
        <div class="text-right">
            <button class="btn btn-success" data-toggle="iframe-modal"
                    data-iframe-src="{{ URL::route('Admin.Permissions.Create') }}">
        ...
        <table class="datatables table">
            <thead>
            <tr>
                <th>{{{ Lang::get('zamb::Admin/Permissions/table.display_name') }}}</th>
                <th>{{{ Lang::get('zamb::Admin/Permissions/table.name') }}}</th>
